...
from haystack.modeling.model.colbert.indexing.codecs.residual_embeddings import ResidualEmbeddings
...
class ResidualCodec:
    ...
    def compress_into_codes(self, embs, out_device):
        ...
        bsize = (1 << 27) // self.centroids.size(0)
