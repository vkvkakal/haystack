...
from haystack.modeling.model.colbert.utils.utils import print_message, flatten
from haystack.modeling.model.colbert.modeling.base_colbert import BaseColBERT
...
class ColBERT(BaseColBERT):
    ...
    def try_load_torch_extensions(cls, use_gpu):
        ...
        segmented_maxsim_cpp = load(
            ...
            sources=[os.path.join(pathlib.Path(__file__).parent.resolve(), "segmented_maxsim.cpp")],
            extra_cflags=["-O3"],
