...
# docs = [Document(id=str(pid), content=passage, meta={"name": str(pid)}) for pid, passage in enumerate(collection)]
...
document_store.update_embeddings(retriever, batch_size=256, update_existing_embeddings=False)
